...
function normalizeWhitelistHosts(hosts) {
...
export async function getSettings() {
  ...
  merged.whitelistHosts = normalizeWhitelistHosts(merged.whitelistHosts);
  return merged;
}
...
export async function setSettings(patch) {
  ...
  next.whitelistHosts = normalizeWhitelistHosts(next.whitelistHosts);
